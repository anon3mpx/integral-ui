...
interface MintState {
  ...
  readonly startPriceTypedValueA: string;
  ...
  readonly actions: {
    ...
    resetMintState: () => void;
    setFullRange: () => void;
    typeStartPriceInputA: (typedValue: string) => void;
...
export const useMintState = create<MintState>((set, get) => ({
  ...
  actions: {
    ...
    typeStartPriceInputA: (typedValue: string) =>
      set({ startPriceTypedValueA: typedValue }),
...
export function useMintActionHandlers(noLiquidity: boolean | undefined): {
  ...
  onStartPriceInputA: (typedValue: string) => void;
  ...
  const onStartPriceInputA = useCallback(
    (typedValue: string) => typeStartPriceInputA(typedValue),
    []
  );
