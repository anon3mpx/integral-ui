...
export const CUSTOM_POOL_DEPLOYER_ADDRESSES: Record<
  PoolDeployerType,
...
export const customPoolDeployerTitleByAddress: Record<Address, string> =
  Object.fromEntries(
    Object.entries(CUSTOM_POOL_DEPLOYER_ADDRESSES).flatMap(([key, chainMap]) =>
      Object.values(chainMap).map((address) => [
        ...
        CUSTOM_POOL_DEPLOYER_TITLES[
          key as keyof typeof CUSTOM_POOL_DEPLOYER_TITLES
        ],
      ])
    )
  );
